...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    // the DAO object we use to access the Post table
    ...
    /**
     * Returns the Database Access Object (DAO) for our Post class. It will create it or just give the cached
     * value.
     */
